                                                            ...
                                                            <div class="card-block">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <h6 class="text-muted f-w-400">{userObject.contacts} / {userObject.allowedContacts} leads</h6>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <p class="mb-1 f-w-600 mt-3">Copywriting</p>
                                                                        <h6 class="text-muted f-w-400">{userObject.allowedGenerateCW} credits left</h6>
                                                                    </div>
                                                                </div>
