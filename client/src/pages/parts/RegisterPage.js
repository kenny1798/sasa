...
function RegisterPage() {
    ...
    const validate = Yup.object({
        username: Yup.string().max(15, "Username must be 15 characters and lower").required(),
        ...
        {formik => (
            <div>
                ...
                <Form>
                    ...
                    <RegisterTextField label="confirmPassword" name="confirmPassword" type="password" />
